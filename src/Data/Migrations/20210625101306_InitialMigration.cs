        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshToken_Id = table.Column<Guid>(nullable: true),
                    RefreshToken_Token = table.Column<string>(nullable: true),
                    RefreshToken_Expires = table.Column<DateTime>(nullable: true),
                    RefreshToken_Created = table.Column<DateTime>(nullable: true),
                    RefreshToken_Revoked = table.Column<DateTime>(nullable: true),
                    RefreshToken_ReplacedByToken = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationRoomEntity", x => new { x.ReservationId, x.RoomId });
                    table.ForeignKey(
                        name: "FK_ReservationRoomEntity_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationRoomEntity_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationServiceEntity", x => new { x.ReservationId, x.ServiceId });
                    table.ForeignKey(
                        name: "FK_ReservationServiceEntity_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationServiceEntity_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationRoomEntity_RoomId",
                table: "ReservationRoomEntity",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationServiceEntity_ServiceId",
                table: "ReservationServiceEntity",
                column: "ServiceId");
